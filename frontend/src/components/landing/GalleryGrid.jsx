...
const categories = ["All", "Wedding", "Portrait", "Editorial", "Commercial"];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-slate-500 max-w-2xl mx-auto">
            Create stunning client galleries with EXIF data overlays and
            category filtering that wows your clients every time.
          </p>
        </motion.div>
