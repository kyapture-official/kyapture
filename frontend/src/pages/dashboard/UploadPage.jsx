// C:/Users/LENOVO/Desktop/kyapture/frontend/src/pages/dashboard/UploadPage.jsx
...
export default function UploadPage() {
  ...
  const handleFilesSelected = useCallback(
          ...
          if (
            ...
            setErrorMsg(
              err.response?.data?.error ||
                ...
                "Upload failed. Please verify S3 cloud configs.",
            );
          }
        }
      } finally {
    ...
    [selectedSlug, uploading, galleries, allowVideo],
  );
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fadeUp">
      ...
      <div className="pb-6 border-b border-gray-200 mb-8">
        ...
        <p className="text-xs text-gray-500 mt-1">
          Select a gallery container and drop your photos to upload them
          directly.
        </p>
      </div>
      ...
      {errorMsg && (
        <div
          role="alert"
          className="mb-6 p-4 rounded-xl bg-red-50 border border-red-200 text-sm text-red-700 font-sans"
        >
          {errorMsg}
        </div>
      )}
      ...
      {galleriesLoading ? (
        ...
        <div className="py-16 text-center border-2 border-dashed border-gray-200 rounded-2xl bg-white p-6 shadow-sm">
          <h3 className="text-sm font-semibold text-gray-900">
            No destination galleries found
          </h3>
          <p className="text-xs text-gray-500 mt-1 mb-6">
            You must build at least one empty collection before uploading
            images.
          </p>
          <Link
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-6">
          ...
          {!uploading && successCount === 0 && (
            <DropZone
              ...
              disabled={uploading} 
              accept={allowVideo ? "image/*,video/mp4,video/quicktime,video/x-m4v" : "image/*"}
            />
          )}
            ...
            <div className="border border-gray-200 rounded-2xl p-6 bg-gray-50/50 flex flex-col items-center justify-center text-center space-y-4 animate-fadeUp">
              ...
              <div>
                <h4 className="text-sm font-semibold text-gray-900">
                  Streaming Assets to S3
                </h4>
                <p className="text-xs text-gray-500 mt-1 max-w-xs">
                  Please keep this browser window open. We are compressing and
            ...
            <div className="border border-green-200 bg-green-50 rounded-2xl p-6 text-center flex flex-col items-center justify-center space-y-4 animate-fadeUp">
              ...
              <div>
                ...
                <p className="text-xs text-green-600 mt-1">
                  Successfully imported <strong>{successCount}</strong> photos
                  into "{uploadedGallery?.title}".
                </p>
              </div>
