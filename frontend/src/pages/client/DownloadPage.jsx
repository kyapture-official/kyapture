    ...
    try {
      ...
      if (err.response?.data instanceof Blob) {
        try {
          ...
          setErrorMsg(parsed.error || parsed.detail || 'Download request failed.')
        } catch {
  ...
  return (
    <ClientLayout>
      <div className="max-w-md mx-auto py-24 px-6 text-center animate-fade-up">
        ...
        {status === 'idle' && (
          <form onSubmit={handleRequest} className="space-y-6 text-left" noValidate>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                onBlur={e   => { e.target.style.borderColor = 'var(--warm)'; e.target.style.background = 'var(--cream2)' }}
              />
              <p className="text-xs leading-relaxed mt-1" style={{ color: 'var(--muted)', fontSize: 10 }}>
        ...
        {status === 'success' && (
          <div className="space-y-6">
            ...
            <h1 className="font-serif text-4xl" style={{ color: 'var(--ink)' }}>Ready!</h1>
        ...
        {status === 'forbidden' && (
          <div className="space-y-6">
            <h1 className="font-serif text-4xl" style={{ color: 'var(--ink)' }}>Not Available</h1>
            <p className="text-sm leading-relaxed max-w-sm mx-auto" style={{ color: 'var(--muted)' }}>
              {errorMsg || 'Downloads are not enabled for this gallery, or your session has expired.'}
            </p>
            <Link
              to={`/g/${username}/${slug}`}
        ...
        {status === 'error' && (
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed max-w-sm mx-auto" style={{ color: 'var(--muted)' }}>
              {errorMsg || "We couldn't process your download request. Please try again or contact your photographer."}
            </p>
